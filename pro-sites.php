...
//------------------------------------------------------------------------//
	...
	function localization() {
		add_action( 'init', function() {
			...
			if ( $this->location == 'plugins' ) {
				load_plugin_textdomain( 'psts', false, basename( dirname( __FILE__ ) ) . '/languages/' );
			} else if ( $this->location == 'mu-plugins' ) {
				load_muplugin_textdomain( 'psts', '/languages/' );
			}
	...
	function init_vars() {
		...
		if ( defined( 'WP_PLUGIN_URL' ) && defined( 'WP_PLUGIN_DIR' ) && file_exists( plugin_dir_path( __FILE__ ) . basename( __FILE__ ) ) ) {
			...
			wp_die( __( 'Es gab ein Problem beim Bestimmen, wo PS-Bloghosting installiert ist. Bitte erneut installieren.', 'psts' ) );
		}
		//Text Domain
	...
	public static function get_default_settings_array() {
		return array(
			...
			'curr_decimal'             => 1,
			'rebrand'                  => __( 'Bloghosting', 'psts' ),
			'lbl_signup'               => __( 'Pro Upgrade', 'psts' ),
			'lbl_curr'                 => __( 'Dein Konto', 'psts' ),
			...
			'free_signup'              => 0,
			'multiple_signup'          => 1,
			'free_name'                => __( 'Basis', 'psts' ),
			'free_msg'                 => __( 'Nein, danke, ich werde vorerst mit einer Basis-Webseite auskommen', 'psts' ),
			'trial_days'               => get_site_option( "supporter_free_days" ),
			'trial_message'            => __( 'Dir verbleiben noch DAYS Tage in Deiner kostenlosen LEVEL-Testversion. Bezahle jetzt, um zu verhindern, dass LEVEL-Funktionen verloren gehen &raquo;', 'psts' ),
			'cancel_message'           => __( 'Deine DAYS-Testversion beginnt, sobald Du unten auf "Webseite abonnieren" klickst. Wir führen eine Vorautorisierung in Höhe von 1EUR durch, um sicherzustellen, dass Deine Kreditkarte gültig ist. Wir werden Deine Karte jedoch erst am Ende Deiner Testversion belasten. Wenn Du nicht bis zum Tag DAYS stornierst, wird Deine Karte mit dem oben angegebenen Abonnementbetrag belastet. Du kannst Dein Abonnement jederzeit kündigen.', 'psts' ),
			'recurring_subscriptions'  => 1,
			'ga_ecommerce'             => 'none',
			'signup_message'           => __( 'Abonniere Deine PRO-Webseite', 'psts' ),
			'feature_message'          => __( 'Aktualisiere auf das LEVEL Paket, um auf diese Funktion zuzugreifen &raquo;', 'psts' ),
			'active_message'           => __( 'Deine Pro Webseite-Berechtigungen verfallen am: DATE<br />Sofern Du Dein Abonnement nicht gekündigt hast oder Deine Webseite über das Tool für Massen-Upgrades aktualisiert wurde, werden Deine Pro Webseite-Berechtigungen automatisch erneuert.', 'psts' ),
			'success_subject'          => __( 'Vielen Dank, dass Du Pro Webseite-Mitglied geworden bist!', 'psts' ),
			'success_msg'              => __( "Vielen Dank, dass Du Pro Webseite-Mitglied geworden bist! \n\nWir haben Deine erste Abonnementzahlung erhalten und Du kannst jetzt auf alle LEVEL-Funktionen zugreifen!\n\nAbonnementzahlungen sollten auf Deiner Kreditkarte oder Deinem Kontoauszug als \"THIS COMPANY\" angezeigt werden. Wenn Du dein Pro Webseite-Abonnement jemals anzeigen, ändern, aktualisieren oder kündigen musst, kannst Du dies hier tun:\nCHECKOUTURL\n\nWenn Du jemals Fragen zur Rechnungsstellung hast, wende Dich bitte an uns:\nhttp://mysite.com/contact/\n\nNochmals vielen Dank für Deine Teilnahme!", 'psts' ),
			'canceled_subject'         => __( 'Dein Pro Webseite-Abonnement wurde gekündigt', 'psts' ),
			'canceled_msg'             => __( "Dein Pro Webseite-Abonnement wurde gekündigt.\n\nDu solltest bis ENDDATE weiterhin Zugriff haben.\n\nEs tut uns sehr leid, Dich gehen zu sehen, aber wir freuen uns darauf, dass Du unsere Dienste wieder abonnierst.\n\nDu kannst Dich hier jederzeit wieder anmelden:\nCHECKOUTURL\n\nDanke!", 'psts' ),
			'receipt_subject'          => __( 'Dein Pro Webseite-Zahlungsbeleg', 'psts' ),
			'receipt_msg'              => __( "Deine Pro Webseite-Abonnementzahlung war erfolgreich!\n\nPAYMENTINFO\n\nAbonnementzahlungen sollten auf Ihrer Kreditkarte oder Ihrem Kontoauszug als \"YOUR COMPANY\ angezeigt werden. Wenn Du dein Pro Webseite-Abonnement jemals anzeigen, ändern, aktualisieren oder kündigen musst, kannst Du dies hier tun:\nCHECKOUTURL\n\nWenn Du jemals Fragen zur Rechnungsstellung hast, wende Dich bitte an uns:\nhttp://mysite.com/contact/\n\nNochmals vielen Dank, dass Du ein geschätztes Mitglied bist!", 'psts' ),
			'expired_subject'          => __( 'Dein Pro Webseite-Status ist abgelaufen', 'psts' ),
			'expired_msg'              => __( "Leider ist der PRO-Status für Deine Site SITENAME (SITEURL) abgelaufen.\n\nHier kannst Du Deinen PPRO Webseite-Status erneuern:\nCHECKOUTURL\n\nWenn Du Probleme mit der Abrechnung hast, wende Dich bitte an uns:\nhttp://mysite.com/contact/\n\nIch freue mich darauf, Dich als geschätztes Mitglied wieder zu haben!", 'psts' ),
			'failed_subject'           => __( 'Deine PRO Webseite-Abonnementzahlung ist fehlgeschlagen', 'psts' ),
			'failed_msg'               => __( "Es scheint, dass es ein Problem mit Deiner letzten PRO Webseite-Abonnementzahlung gibt. Tut mir leid.\n\nBitte aktualisiere Deine Zahlungsinformationen oder ändere Deine Zahlungsmethode so schnell wie möglich, um ein Versagen der PRO Webseite-Funktionen zu vermeiden. Wenn Du Probleme mit der Abrechnung hast, wende Dich bitte an uns:\nhttp://mysite.com/contact/\n\nNochmals vielen Dank für Deine Mitgliedschaft!", 'psts' ),
			'extension_subject'           => __( 'Du hast eine kostenlose PRO Webseite-Mitgliedschaft erhalten.', 'psts' ),
			'extension_msg'               => __( "Wir haben Dir PRO Webseite Zugriff gewährt. Du kannst jetzt alle Vorteile eines Pro Webseite-Mitglieds nutzen.\n\nDiese Vorteile stehen Dir bis ENDDATE zur Verfügung.\n\nNach diesem Datum kehrt Deine Seite zu einer Basis-Webseite zurück.\n\nDu kannst Dich jederzeit über den unten stehenden Link anmelden:\nCHECKOUTURL\n\nDanke!", 'psts' ),
			'revoked_subject'           => __( 'Dein permanenter PRO Webseite-Status hat sich geändert.', 'psts' ),
			'revoked_msg'               => __( "Dein permanenter PRO Webseite-Status wurde entfernt. Du hast weiterhin alle Vorteile Deiner PRO Webseite-Mitgliedschaft bis ENDDATE.\n\nNach diesem Datum kehrt Deine Seite zu einer Basis-Webseite zurück.\n\nDu kannst Dich jederzeit über den unten stehenden Link anmelden:\nCHECKOUTURL\n\nDanke!", 'psts' ),
			'pypl_site'                => 'AT',
			'pypl_currency'            => 'EUR',
			'pypl_status'              => 'test',
			'pypl_enable_pro'          => 0,
			'stripe_ssl'               => 0,
			'stripe_debug'             => 0,
			'mp_name'                  => __( 'Manuelle Zahlung', 'psts' ),
			'mp_show_form'             => 0,
			'mp_email'                 => get_site_option( "admin_email" ),
			'pt_name'                  => __( 'Premium Themes', 'psts' ),
			'pt_text'                  => __( 'Aktualisiere auf LEVEL, um dieses Premium-Thema zu aktivieren &raquo;', 'psts' ),
			'ps_level'                 => 1,
			'ps_email'                 => get_site_option( "admin_email" ),
			'ps_name'                  => __( 'Premium Support', 'psts' ),
			'ps_message'               => __( 'Du kannst uns hier eine priorisierte direkte E-Mail-Supportanfrage senden, wenn Du Hilfe bei Deiner Website benötigst.', 'psts' ),
			'ps_notice'                => __( 'Um den Premium-Support zu aktivieren, aktualisiere bitte auf LEVEL &raquo;', 'psts' ),
			'publishing_level'         => 1,
			'publishing_message_posts' => __( 'Um das Veröffentlichen von Beiträgen zu aktivieren, aktualisiere bitte auf LEVEL &raquo;', 'psts' ),
			'publishing_message_pages' => __( 'Um das Veröffentlichen von Seiten zu aktivieren, aktualisiere bitte auf LEVEL &raquo;', 'psts' ),
			'quota_message'            => __( 'Aktualisiere auf LEVEL, um SPACE Upload-Speicherplatz zu erhalten!', 'psts' ),
			'quota_out_message'        => __( 'Du hast keinen Upload-Speicherplatz mehr! Bitte aktualisiere auf LEVEL, um SPACE Upload-Speicherplatz zu erhalten.', 'psts' ),
			'xmlrpc_level'             => 1,
			'xmlrpc_message'           => __( 'Um XML-RPC Remote Publishing zu aktivieren, aktualisiere bitte auf LEVEL &raquo;', 'psts' ),
			'bp_notice'                => __( 'Aktualisiere auf LEVEL, um auf diese Funktion zuzugreifen &raquo;', 'psts' ),
			'pp_name'                  => __( 'Premium Plugins', 'psts' ),
			'ads_name'                 => __( 'Werbungen ausschalten', 'psts' ),
			'ads_level'                => 1,
			'ads_enable_blogs'         => 0,
			'ads_count'                => 3,
			'ads_before_page'          => 0,
			...
			'bu_level'                 => 1,
			'bu_credits_1'             => 10,
			'bu_option_msg'            => __( 'Upgrade CREDITS Webseiten für nur PRICE ein Jahr auf LEVEL:', 'psts' ),
			'bu_checkout_msg'          => __( 'Du kannst mehrere Webseiten zu geringeren Kosten upgraden, indem Du unten die Bloghosting-Gutschriften erwirbst. Kehre nach dem Kauf einfach zu dieser Seite zurück, suche über das Tool unten auf der Seite nach Deinen Webseiten und aktualisiere sie auf den Bloghosting-Status. Jede Seite wird für ein Jahr aktualisiert.', 'psts' ),
			...
			'bu_name'                  => __( 'Massen-Upgrades', 'psts' ),
			'bu_link_msg'              => __( 'Kaufe Guthaben, um mehrere Webseiten zu einem reduzierten Preis zu aktualisieren!', 'psts' ),
			'ptb_front_disable'        => 1,
			'ptb_front_msg'            => __( 'Diese Seite ist vorübergehend deaktiviert, bis die Zahlung eingegangen ist. Bitte versuche es später erneut.', 'psts' ),
			'ptb_checkout_msg'         => __( 'Du musst bezahlen, um Deine Webseite zu aktivieren.', 'psts' ),
			'pq_level'                 => 1,
			'pq_quotas'                => array(
			...
			'uh_level'                 => 1,
			'uh_message'               => __( 'Um das Einbetten von HTML zu aktivieren, aktualisiere bitte auf LEVEL &raquo;', 'psts' ),
			'co_pricing'               => 'disabled',
	...
	function install() {
		...
		if ( ! is_multisite() ) {
			$this->trigger_install_error( __( 'WordPress Multisite ist erforderlich, um dieses Plugin auszuführen. <a target="_blank" href="http://codex.wordpress.org/Create_A_Network">Erstelle ein Multisite-Netzwerk</a>.', 'psts' ), E_USER_ERROR );
		}
	...
	*/
	...
	function weekly_summary() {
		...
		if ( $current_total > $last_total ) {
			...
			$active_diff = "<span style='font-size: 18px; font-family: arial;'>" . __( 'Keine Änderung', 'psts' ) . "</span>";
		}

		$text = sprintf( __( '%s aktive PRO Webseiten %s seit letzter Woche', 'psts' ), "<p><span style='font-size: 24px; font-family: arial;'>" . number_format_i18n( $current_total ) . "</span><span style='color: rgb(85, 85, 85);'>", "</span>$active_diff<span style='color: rgb(85, 85, 85);'>" ) . "</span></p>";
		...
		$text .= sprintf( __( '%s Stornierungen in dieser Woche %s im Vergleich zur letzten Woche', 'psts' ), "\n<p><span style='font-size: 24px; font-family: arial;'>" . number_format_i18n( $this_week['cancels'] ) . "</span><span style='color: rgb(85, 85, 85);'>", "</span>$diff<span style='color: rgb(85, 85, 85);'>" ) . "</span></p>";

		// Current active trials
		$text .= sprintf( '<p>' . __( '%s aktive Testversionen.', 'psts' ) . '</p>', "<span style='font-size: 24px; font-family: arial;'>" . number_format_i18n( $number_trial ) . "</span>" );
	...
	function plug_network_pages() {
		...
		//main page
		$psts_main_page         = add_menu_page( __( 'Bloghosting', 'psts' ), __( 'Bloghosting', 'psts' ), 'manage_network_options', 'psts', array(
			&$this,
			'admin_modify',
		), 'dashicons-plus' );
		$psts_manage_sites_page = add_submenu_page( 'psts', __( 'Seitenverwaltung', 'psts' ), __( 'Seitenverwaltung', 'psts' ), 'manage_network_options', 'psts', array(
			&$this,
			'admin_modify',
		) );
		...
		//stats page
		$psts_stats_page = add_submenu_page( 'psts', __( 'Bloghosting Statistik', 'psts' ), __( 'Statistiken', 'psts' ), 'manage_network_options', 'psts-stats', array(
			&$this,
			'admin_stats',
		) );
		...
		//levels page
		$psts_levels_page = add_submenu_page( 'psts', __( 'Hostingpakete', 'psts' ), __( 'Hostingpakete', 'psts' ), 'manage_network_options', 'psts-levels', array(
			&$this,
			'admin_levels',
		) );
		...
		//modules page
		$psts_modules_page = add_submenu_page( 'psts', __( 'Bloghosting Module', 'psts' ), __( 'Module', 'psts' ), 'manage_network_options', 'psts-modules', array(
			&$this,
			'admin_modules',
		) );
		...
		$psts_gateways_page = add_submenu_page( 'psts', __( 'Bloghosting Gateways', 'psts' ), __( 'Zahlungsgateways', 'psts' ), 'manage_network_options', 'psts-gateways', array(
		...
		$psts_settings_page = add_submenu_page( 'psts', __( 'Bloghosting Einstellungen', 'psts' ), __( 'Einstellungen', 'psts' ), 'manage_network_options', 'psts-settings', array(
			'ProSites_View_Settings',
			'render_page',
		) );
	...
	function checkout_page_load( $query ) {
		...
		wp_localize_script( 'psts-checkout', 'prosites_checkout', array(
			...
			'confirm_cancel' => __( "Bitte beachte, dass Du bei Kündigung Deines Abonnements nicht gegen zukünftige Preiserhöhungen immun bist. Der Preis für nicht gekündigte Abonnements wird niemals steigen!\n\nMöchtest Du Dein Abonnement wirklich kündigen?\nDiese Aktion kann nicht rückgängig gemacht werden!", 'psts'),
			'button_signup' => __( "ABONNIEREN", 'psts' ),
			'button_choose' => __( "Wähle ein Paket", 'psts' ),
			'button_chosen' => __( "Dieses Paket", 'psts' ),
		...
		if ( $blog_id || $domain ) {
			...
			if ( $session_coupon = ProSites_Helper_Session::session( 'COUPON_CODE' ) ) {
				if ( !empty( $_POST ) && $this->check_coupon( $session_coupon, $blog_id, intval( @$_POST['level'] ), $_POST['period'], '' ) ) {
					...
					if ( isset( $_POST['level'] ) && is_numeric( $_POST['level'] ) ) {
						$this->errors->add( 'coupon', __( 'Der von Dir eingegebene Gutscheincode ist für das von Dir gewählte Paket nicht gültig.', 'psts' ) );
					} else {
						$this->errors->add( 'coupon', __( 'Hoppla! Der von Dir eingegebene Gutscheincode ist ungültig.', 'psts' ) );
						ProSites_Helper_Session::unset_session( 'COUPON_CODE' );
					}
				}
			}
			...
			if ( isset( $_POST['coupon-submit'] ) ) {
				...
				if ( $coupon ) {
					...
					$this->log_action( $blog_id, __( "Der Benutzer hat seiner Bestellung auf der Checkout-Seite einen gültigen Gutschein hinzugefügt:", 'psts' ) . ' ' . $code, $domain );
				} else {
					$this->errors->add( 'coupon', __( 'Hoppla! Der von Dir eingegebene Gutscheincode ist ungültig.', 'psts' ) );
					$this->log_action( $blog_id, __( "Der Benutzer hat versucht, seiner Bestellung auf der Checkout-Seite einen ungültigen Gutschein hinzuzufügen:", 'psts' ) . ' ' . $code, $domain );
				}
			}
		} else {
	...
	function email_notification( $blog_id, $action, $email = false, $args = array() ) {
		...
		switch ( $action ) {
			case 'success':
				...
				$this->log_action( $blog_id, sprintf( __( 'Anmeldeerfolgs-Email an %s gesendet', 'psts' ), $email ) );
				break;
			...
			case 'receipt':
				...
				if ( $result->term == 1 || $result->term == 3 || $result->term == 12 ) {
					$term = sprintf( __( 'je %s Monat(e)', 'psts' ), $result->term );
				} else {
					$term = $result->term;
				}
				$level = $result->level;
				...
				$payment_info .= sprintf( __( 'Derzeitiger Plan: %s', 'psts' ), $level_name ) . "\n\n";

				if ( $result->gateway ) {
					$nicename = ProSites_Helper_Gateway::get_nice_name( $result->gateway );
					$payment_info .= sprintf( __( 'Bezahlverfahren: %s', 'psts' ), $nicename ) . "\n";
				}

				if ( $term ) {
					$payment_info .= sprintf( __( 'Zahlungsfrist: %s', 'psts' ), $term ) . "\n";
				}

				$trialing = ProSites_Helper_Registration::is_trial( $blog_id );
				$amount = $trialing ? 0.0 : $result->amount;
				$payment_info .= sprintf( __( 'Zahlungsbetrag: %s', 'psts' ), $this->format_currency( false, $amount ) . ' ' . $this->get_setting( 'currency' ) ) . "\n";
				...
				if( ! empty( $args ) ) {
					...
					if( isset( $args['items'] ) ) {
						...
						$payment_info .= sprintf( __( 'Gesamt bezahlt: %s%s', 'psts' ), $symbol, $this->format_currency( false, $items_total ) . ' ' . $this->get_setting( 'currency' ) ) . "\n";
					} else {
						/**
						 * @todo Remove prior to release
						 */
						if( isset( $args['setup_amount'] ) ) {
							$payment_info .= sprintf( __( 'Einmalige Einrichtungsgebühr: %s', 'psts' ), $this->format_currency( false, $args['setup_amount'] ) . ' ' . $this->get_setting( 'currency' ) ) . "\n";
						} else {
							$args['setup_amount'] = 0;
						}
						if( isset( $args['discount_amount'] ) ) {
							$payment_info .= sprintf( __( 'Rabatt: -%s', 'psts' ), $this->format_currency( false, abs( $args['discount_amount'] ) ) . ' ' . $this->get_setting( 'currency' ) ) . "\n";
						} else {
						...
						if( isset( $args['plan_change_amount'] ) ) {
							switch( $args['plan_change_mode'] ) {
								case 'upgrade':
									$payment_info .= sprintf( __( 'Plan geändert: %s', 'psts' ), $this->format_currency( false, abs( $args['plan_change_amount'] ) ) . ' ' . $this->get_setting( 'currency' ) ) . "\n";
									break;
								case 'downgrade':
									$payment_info .= sprintf( __( 'Plan geändert: -%s', 'psts' ), $this->format_currency( false, abs( $args['plan_change_amount'] ) ) . ' ' . $this->get_setting( 'currency' ) ) . "\n";
									break;
						...
						if( $zero_cost_change ) {
							// No cost to upgrade
							$payment_info .= sprintf( __( 'Gesamtbetrag bezahlt: %s', 'psts' ), $this->format_currency( false,  0 ) . ' ' . $this->get_setting( 'currency' ) ) . "\n";
						} else {
							$payment_info .= sprintf( __( 'Gesamtbetrag bezahlt: %s', 'psts' ), $this->format_currency( false, ( $amount + $args['setup_amount'] + $args['plan_change_amount'] - $args['discount_amount'] ) ) . ' ' . $this->get_setting( 'currency' ) ) . "\n";
						}
				...
				if ( $result->gateway == 'trial' || ! empty( $trialing ) ) {
					$trial_info = "\n" . __( '*** BITTE BEACHTE ***', 'psts' ) . "\n";
					$trial_info .= sprintf( __( 'Dein Abonnement wird erst belastet, wenn Deine Testversion mit %s endet. Dies gilt gegebenenfalls nicht für Einrichtungsgebühren und andere Vorabkosten.', 'psts' ), date_i18n( get_option( 'date_format' ), $result->expire ) );
				...
				$this->log_action( $blog_id, sprintf( __( 'Zahlungsbeleg-Email an %s gesendet', 'psts' ), $email ) );
				break;
			...
			case 'canceled':
				...
				$this->log_action( $blog_id, sprintf( __( 'Abonnement storniert Email an %s', 'psts' ), $email ) );
				break;
			...
			case 'expired':
				...
				$this->log_action( $blog_id, sprintf( __( 'Abgelaufen Email an %s gesendet', 'psts' ), $email ) );
				break;
			...
			case 'failed':
				...
				$this->log_action( $blog_id, sprintf( __( 'Zahlung fehlgeschlagen Email an %s gesendet', 'psts' ), $email ) );
				break;
			case 'extension':
				//get end date from expiration
				$end_date = date_i18n( get_blog_option( $blog_id, 'date_format' ), $this->get_expire( $blog_id ) );
				...
				$this->log_action( $blog_id, sprintf( __( 'Manuelle Erweiterung-Email an %s gesendet', 'psts' ), $email ) );
				break;
			case 'permanent_revoked':
				...
				$this->log_action( $blog_id, sprintf( __( 'Email für dauerhaftem Status an %s gesendet', 'psts' ), $email ) );
				break;
		}
    ...
    */
	public static function send_receipt( $transaction ) {
		...
		$payment_info = sprintf( __( 'Derzeitiger Plan: %s', 'psts' ), $level_name ) . "\n";
		$payment_info .= sprintf( __( 'Bezahlverfahren: %s', 'psts' ), $gateway ) . "\n";
		if ( $term ) {
			$payment_info .= sprintf( __( 'Zahlungsfrist: %s', 'psts' ), $term ) . "\n<hr />";
		}
		$payment_info .= sprintf( __( 'Transaktion/Rechnung #: %s', 'psts' ), $transaction->invoice_number) . "\n";
		$payment_info .= sprintf( __( 'Transaktions-/Rechnungsdatum: %s', 'psts' ), $transaction->invoice_date) . "\n\n";
		$payment_info .= '<strong>' . __( 'Transaktionsdetails:', 'psts' ) . "</strong>\n\n";
		...
		if ( empty( $tax_rate ) ) {
			$payment_info .= "\n<strong>" . sprintf( __( 'Gesamt: %s', 'psts' ), $psts->format_currency( $transaction->currency_code, $total ) ) . "</strong>\n\n";
		} else {
			$payment_info .= "\n" . sprintf( __( 'Zwischensumme: %s', 'psts' ), $psts->format_currency( $transaction->currency_code, $subtotal ) ) . "\n";
			$payment_info .= sprintf( __( 'Steuersatz: %s%%', 'psts' ), ($tax_rate * 100) ) . "\n";
			$payment_info .= sprintf( __( 'Steuerbetrag: %s', 'psts' ), $psts->format_currency( $transaction->currency_code, $tax ) ) . "\n";
			$payment_info .= '<strong>' . sprintf( __( 'Gesamt: %s', 'psts' ), $psts->format_currency( $transaction->currency_code, $total ) ) . "</strong>\n\n";
		}
		...
		$psts->log_action( $transaction->blog_id, sprintf( __( 'Zahlungsbeleg-Email an %s gesendet', 'psts' ), $email ) );
    ...
    */
	function extend( $blog_id, $extend, $gateway = false, $level = 1, $amount = false, $expires = false, $is_recurring = true, $manual_notify = false, $extend_type = '', $set_trial = false ) {
		...
		if ( $exists != $new_expire ) { //only log if blog expiration date is not changing
			if ( $new_expire >= 9999999999 ) {
				$this->log_action( $blog_id, __( 'Der Ablauf des Bloghosting-Status wurde dauerhaft verlängert.', 'psts' ) );
			} else {
				$this->log_action( $blog_id, sprintf( __( 'Der Ablauf des Bloghosting-Status wurde bis %s verlängert.', 'psts' ), date_i18n( get_blog_option( $current_site->blog_id, 'date_format' ), $new_expire ) ) );
			}
		}
		...
		if ( intval( $exists ) <= time() ) { //count reactivating account as upgrade
			...
			if ( $old_level < $level ) {
				$this->log_action( $blog_id, sprintf( __( 'Bloghosting-Level von "%s" auf "%s" aktualisiert.', 'psts' ), $this->get_level_setting( $old_level, 'name' ), $this->get_level_setting( $level, 'name' ) ) );
				do_action( 'psts_upgrade', $blog_id, $level, $old_level );
			} else if ( $old_level > $level ) {
				$this->log_action( $blog_id, sprintf( __( 'Bloghosting-Level von "%s" auf "%s" herabgestuft.', 'psts' ), $this->get_level_setting( $old_level, 'name' ), $this->get_level_setting( $level, 'name' ) ) );
	...
	function withdraw( $blog_id, $withdraw = false, $domain = false ) {
		...
		$this->log_action( $blog_id, __( 'Der Bloghosting-Status wurde zurückgezogen.', 'psts' ) );
	...
	*/
	...
	function page_title_output( $title, $id = null ) {
		...
		if ( ! is_user_logged_in() && isset( $_GET['bid'] ) ) {
			return sprintf( __( '%1$s: %2$s', 'psts' ), $title, __( 'Bitte einloggen', 'psts' ) );
		} else {
	...
	function register_psts_style() {
		...
		wp_localize_script( 'psts-js', 'prosites_admin', array(
			'currency_select_placeholder' => __( 'Aktiviere Gateways', 'psts' ),
			'disable_premium_plugin' => __( 'Durch Aktivieren dieses Moduls wird das Premium Plugin-Modul deaktiviert.', 'psts' ),
		...
		wp_localize_script( 'psts-js-levels', 'prosites_levels', array(
			...
			'confirm_feature_delete' => __( 'Möchtest Du diese benutzerdefinierte Funktion wirklich entfernen?', 'psts' ),
		) );
	...
	*/
	...
	function add_column( $columns ) {
		...
		$columns     = array_merge( $first_array, array( 'psts' => __( 'Bloghosting', 'psts' ) ), $columns );
	...
	function add_column_field( $column, $blog_id ) {
		...
		if ( $column == 'psts' ) {
			if ( isset( $this->column_fields[ $blog_id ] ) ) {
				echo "<a title='" . __( 'Seite verwalten &raquo;', 'psts' ) . "' href='" . network_admin_url( 'admin.php?page=psts&bid=' . $blog_id ) . "'>" . $this->column_fields[ $blog_id ] . "</a>";
			} else {
				echo "<a title='" . __( 'Seite verwalten &raquo;', 'psts' ) . "' href='" . network_admin_url( 'admin.php?page=psts&bid=' . $blog_id ) . "'>" . __( 'Verwalten &raquo;', 'psts' ) . "</a>";
			}
		}
	}
...
';
	...
	function admin_modify() {
		...
		if ( isset( $_POST['log_entry'] ) ) {
			...
			echo '<div id="message" class="updated fade"><p>' . __( 'Protokolleintrag hinzugefügt.', 'psts' ) . '</p></div>';
		}
		...
		if ( isset( $_POST['psts_extend'] ) ) {
			...
			echo '<div id="message" class="updated fade"><p>' . __( 'Seite verlängert.', 'psts' ) . '</p></div>';
		}
		...
		if ( isset( $_POST['psts_transfer_pro'] ) ) {
			...
			if ( ! $new_bid ) {
				echo '<div id="message" class="error"><p>' . __( 'Bitte gib die Blog-ID einer Seite ein, auf die übertragen werden soll.', 'psts' ) . '</p></div>';
			} else if ( ! ProSites_Helper_ProSite::is_free_site( $new_bid ) ) {
				echo '<div id="message" class="error"><p>' . __( 'Bloghosting-Status konnte nicht übertragen werden: Die ausgewählte Seite ist bereits eine Pro-Site. Du musst den Pro-Status entfernen und alle vorhandenen Abonnements kündigen, die an diese Seite gebunden sind.', 'psts' ) . '</p></div>';
			} else {
				...
				$this->log_action( $current_bid, sprintf( __( 'Bloghosting Status von %s an BlogID %d übertragen', 'psts' ), $current_user->display_name, $new_bid ) );
				$this->log_action( $new_bid, sprintf( __( 'Bloghosting Status von %s von BlogID %d übertragen', 'psts' ), $current_user->display_name, $current_bid ) );
				do_action( 'psts_transfer_pro', $current_bid, $new_bid ); //for gateways to hook into for api calls, etc.
				echo '<div id="message" class="updated fade"><p>' . sprintf( __( 'Bloghosting Status auf BlogID %d übertragen', 'psts' ), (int) $_POST['new_bid'] ) . '</p></div>';
			}
		}
		...
		if ( isset( $_POST['psts_modify'] ) ) {
			...
			if ( isset( $_POST['psts_remove'] ) ) {
				...
				echo '<div id="message" class="updated fade"><p>' . __( 'Bloghosting Status entfernt.', 'psts' ) . '</p></div>';
			}

			if ( isset( $_POST['psts_receipt'] ) ) {
				$this->email_notification( (int) $_POST['bid'], 'receipt', $_POST['receipt_email'] );
				echo '<div id="message" class="updated fade"><p>' . __( 'Email-Quittung gesendet.', 'psts' ) . '</p></div>';
			}
		...
		if ( isset( $_GET['bid'] ) ) {
			...
			if ( ! $blog_count ) {
				echo '<div id="message" class="updated fade"><p>' . __( 'Ungültige Blog-ID. Bitte versuche es erneut.', 'psts' ) . '</p></div>';
				$blog_id = false;
			} else {
		...
		<h1><?php _e( 'Bloghosting Management', 'psts' ); ?></h1>
		...
		if ( $blog_id ) {
			...
			<h3><?php _e( 'Seite verwalten', 'psts' );
			...
			if ( $result ) {
				if ( $result->term == 1 || $result->term == 3 || $result->term == 12 ) {
					$term = sprintf( _n( '%s Monat','%s Monate', $result->term, 'psts' ), $result->term );
				} else {
					$term = $result->term;
				}
			} else {
			...
			if ( $expire && $expire > time() ) {
				echo '<p><strong>' . __( 'Aktuelles Bloghosting', 'psts' ) . '</strong></p>';

				echo '<ul>';
				if ( $expire > 2147483647 ) {
					echo '<li>' . __( 'Bloghosting-Berechtigungen verfallen: <strong>NIEMALS</strong>', 'psts' ) . '</li>';
				} else {
					$trialing = ProSites_Helper_Registration::is_trial( $blog_id );
					$active_trial = $trialing ? __( '(Aktive Testversion)', 'psts') : '';

					echo '<li>' . sprintf( __( 'Bloghosting-Berechtigungen verfallen: <strong>%s</strong>', 'psts' ), date_i18n( get_option( 'date_format' ), $expire ) ) . ' ' . $active_trial . '</li>';
				}

				echo '<li>' . sprintf( __( 'Level: <strong>%s</strong>', 'psts' ), $current_level . ' - ' . @$levels[ $current_level ]['name'] ) . '</li>';
				if ( $result->gateway ) {
					$nicename = ProSites_Helper_Gateway::get_nice_name( $result->gateway );
					echo '<li>' . sprintf( __( 'Zahlungs-Gateways: <strong>%s</strong>', 'psts' ), $nicename ) . '</li>';
				}
				if ( $term ) {
					echo '<li>' . sprintf( __( 'Zahlungsfrist: <strong>%s</strong>', 'psts' ), $term ) . '</li>';
				}
				echo '</ul>';

			} else if ( $expire && $expire <= time() ) {
				echo '<p><strong>' . __( 'Abgelaufene Pro Seite', 'psts' ) . '</strong></p>';

				echo '<ul>';
				echo '<li>' . sprintf( __( 'Bloghosting-Berechtigungen verfallen: <strong>%s</strong>', 'psts' ), date_i18n( get_option( 'date_format' ), $expire ) ) . '</li>';

				echo '<li>' . sprintf( __( 'Vorheriges Level: <strong>%s</strong>', 'psts' ), $current_level . ' - ' . @$levels[ $current_level ]['name'] ) . '</li>';
				if ( $result->gateway ) {
					$nicename = ProSites_Helper_Gateway::get_nice_name( $result->gateway );
					echo '<li>' . sprintf( __( 'Vorheriges Zahlungsgateway: <strong>%s</strong>', 'psts' ), $nicename ) . '</li>';
				}
				if ( $term ) {
					echo '<li>' . sprintf( __( 'Vorherige Zahlungsfrist: <strong>%s</strong>', 'psts' ), $term ) . '</li>';
				}
				echo '</ul>';

			} else {
				echo '<p><strong>"' . get_blog_option( $blog_id, 'blogname' ) . '" ' . __( 'war noch nie eine Pro Site.', 'psts' ) . '</strong></p>';
			}
				...
				<div class="metabox-holder">
						...
						<div style="width: 49%;" class="postbox-container">
							<div class="postbox">
								<h3 class="hndle" style="cursor:auto;">
									<span><?php _e( 'Abonnementinformationen', 'psts' ); ?></span></h3>
					...
					<?php if ( has_action( 'psts_subscriber_info' ) ) { ?>
						<div style="width: 49%;margin-left: 2%;" class="postbox-container">
							<div class="postbox">
								<h3 class="hndle" style="cursor:auto;">
									<span><?php _e( 'Abonnenteninformationen', 'psts' ); ?></span></h3>
			...
			<div id="poststuff" class="metabox-holder">
				<div class="postbox">
					<h3 class="hndle" style="cursor:auto;"><span><?php _e( 'Kontoverlauf', 'psts' ) ?></span></h3>

					<div class="inside">
						<span class="description"><?php _e( 'Dies protokolliert im Grunde jede Aktion, die im System bezüglich der Seite für einen Audit-Trail ausgeführt wird.', 'psts' ); ?></span>
						...
						<div style="height:150px;overflow:auto;margin-top:5px;margin-bottom:5px;">
							<table class="widefat">
								...
								if ( is_array( $log ) && count( $log ) ) {
									...
									echo '<tr><td colspan="2">' . __( 'Für diese Seite wurde noch kein Verlauf aufgezeichnet.', 'psts' ) . '</td></tr>';
								}
								?>
							</table>
						</div>
						<form method="post" action="">
							<input type="text" placeholder="<?php _e( 'Füge einen benutzerdefinierten Protokolleintrag hinzu...', 'psts' ); ?>" name="log_entry" style="width:91%;"/>
							<input type="submit" class="button-secondary" name="add_log_entry" value="<?php _e( 'Hinzufügen &raquo;', 'psts' ) ?>" style="width:8%;float:right;"/>
						</form>
					</div>
				</div>
			</div>
			...
			<div id="poststuff" class="metabox-holder">
				...
				<div style="width: 49%;" class="postbox-container">
					<div class="postbox">
						<h3 class="hndle" style="cursor:auto;">
							<span><?php _e( 'Bloghosting-Status manuell erweitern', 'psts' ) ?></span></h3>

						<div class="inside">
							<span class="description"><?php _e( 'Bitte beachte dass durch diese Änderungen die Zahlungstermine oder -stufen für bestehende Abonnements nicht angepasst werden.', 'psts' ); ?></span>
							...
							<form method="post" action="">
								<table class="form-table">
									...
									<tr valign="top">
										<th scope="row"><?php _e( 'Zeitraum', 'psts' ) ?></th>
										<td><select name="extend_months">
											...
											<select name="extend_days">
												...
												?>
											</select><?php _e( 'Tage', 'psts' ); ?>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php _e( 'oder', 'psts' ); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<label><input type="checkbox" name="extend_permanent" value="1"/> <?php _e( 'Dauerhaft', 'psts' ); ?>
											</label>
											<br/><?php _e( 'Zeitraum für dem Du die Website erweitern möchtest. Bei Null belassen, um nur den Level zu ändern.', 'psts' ); ?>
										</td>
									</tr>
									<tr valign="top">
										<th scope="row"><?php _e( 'Paket', 'psts' ) ?></th>
										<td><select name="extend_level">
											...
											<br/><?php _e( 'Wähle aus auf welche Ebene die Seite Zugriff haben soll.', 'psts' ); ?>
										</td>
									</tr>
									<tr valign="top">
										<th scope="row"><?php _e( 'Verlängern als', 'psts' ) ?></th>
										<td>
										<?php
											...
											<select name="extend_type">
												...
												<option value="manual" <?php selected( $gateway != 'trial' ); ?>><?php _e( 'Manuell', 'psts' ); ?></option>
											</select>
											<br/><?php _e( 'Wähle aus ob der Benutzer weiterhin in der Testphase verbleibt oder als kostenpflichtiges Mitglied aktualisiert werden soll.', 'psts' ); ?>
										</td>
									</tr>
									<?php
									...
									<tr valign="top">
										<th scope="row">
											<?php esc_html_e( 'Stripe Reaktivieren', 'psts' ); ?>
										</th>
										<td>
											<input type="checkbox" name="attempt_stripe_reactivation" value="1"/>
											<?php esc_html_e( 'Versuche das frühere Stripe-Abonnement wieder zu aktivieren.', 'psts' ); ?><br/><small><?php esc_html_e( 'Hinweis: Wir können das Abonnement nicht reaktivieren, wenn der Endzeitraum bereits erreicht ist. Tu dies nur, wenn das Abonnement versehentlich gekündigt wurde oder Du die ausdrückliche Erlaubnis des Kunden hast.', 'psts' ); ?></small>
										</td>
									</tr>
										<?php
									}
									...
									<tr valign="top">
										<td colspan="2" style="text-align:right;">
											<input class="button-primary" type="submit" name="psts_extend" value="<?php _e( 'Erweitern &raquo;', 'psts' ) ?>"/>
										</td>
									</tr>
								</table>
								<hr/>
								<table class="form-table">
									<tr valign="top">
										<td><label>Übertrage den Pro-Status auf die Blog-ID:
												<input type="text" name="new_bid" size="3"/></label></td>
										<td style="text-align:right;">
											<input class="button-primary psts_confirm" type="submit" name="psts_transfer_pro" value="<?php _e( 'Übertragen &raquo;', 'psts' ) ?>"/>
										</td>
									</tr>
								</table>
							</form>
				...
				<?php if ( is_pro_site( $blog_id ) || has_action( 'psts_modify_form' ) ) { ?>
					<div style="width: 49%;margin-left: 2%;" class="postbox-container">
						<div class="postbox">
							<h3 class="hndle" style="cursor:auto;">
								<span><?php _e( 'Ändere den Bloghosting-Status', 'psts' ) ?></span></h3>
							...
							<div class="inside">
								<form method="post" action="">
									...
									<?php if ( is_pro_site( $blog_id ) ) { ?>
										<p>
											<label><input type="checkbox" name="psts_remove" value="1"/> <?php _e( 'Entferne den Pro-Status von dieser Seite.', 'psts' ); ?>
											</label></p>
									<?php } ?>

									<?php if ( $last_payment = $this->last_transaction( $blog_id ) ) { ?>
										<p>
											<label><input type="checkbox" name="psts_receipt" value="1"/> <?php _e( 'Sende eine Quittungskopie für die letzte Zahlung per E-Mail an:', 'psts' ); ?>
												<input type="text" name="receipt_email" value="<?php echo get_blog_option( $blog_id, 'admin_email' ); ?>"/></label>
										</p>
									<?php } ?>

									<p class="submit">
										<input type="submit" name="psts_modify" class="button-primary psts_confirm" value="<?php _e( 'Ändern &raquo;', 'psts' ) ?>"/>
									</p>
								</form>
							</div>
						</div>
			...
			<div class="metabox-holder">
				<div class="postbox">
					<h3 class="hndle" style="cursor:auto;"><span><?php _e( 'Verwalten einer Site', 'psts' ) ?></span></h3>
					...
					<div class="inside">
							...
							<table class="form-table">
								...
								<tr valign="top">
									...
									<td><input type="text" size="17" name="bid" value=""/>
										<input class="button-secondary" type="submit" value="<?php _e( 'Fortfahren &raquo;', 'psts' ) ?>"/>
									</td>
								</tr>
							</table>
						</form>
						...
						<form method="get" action="">
							<table class="form-table">
								<input type="hidden" name="page" value="psts"/>
								<tr valign="top">
									<th scope="row"><?php _e( 'Aktivierungsschlüssel:', 'psts' ) ?></th>
									<td><input type="text" size="17" name="activation_key" value=""/>
										<input class="button-secondary" type="submit" value="<?php _e( 'Blog aktivieren &raquo;', 'psts' ) ?>"/>
									</td>
								</tr>
							</table>
						</form>
						...
						<form method="get" action="sites.php" name="searchform">
							<table class="form-table">
								<tr valign="top">
									<th scope="row"><?php _e( 'Oder suche nach einer Site:<br /><small>Nach Blog-ID, IP-Adresse oder Pfad/Domain</small>', 'psts' ) ?></th>
									<td><input type="text" size="17" value="" name="s"/>
										<input class="button-secondary" type="submit" value="<?php _e( 'Webseiten suchen &raquo;', 'psts' ) ?>" id="submit_sites" name="submit"/>
									</td>
								</tr>
							</table>
						</form>
			...
			$("#monthly_signup_stats").bind("plothover", function (event, pos, item) {
				if (item) {
					if (previousPoint != item.datapoint) {
						...
						var monthname = new Array("Jan", "Feb", "Mar", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez");
...
<?php echo $this->weekly_summary(); ?>
	...
	<div class="metabox-holder">
		...
		<div class="postbox">
			<h3 class="hndle" style="cursor:auto;"><span><?php _e( 'Monatliche Aktivitätsübersicht', 'psts' ) ?></span></h3>

			<div class="inside">
				<div id="monthly_signup_stats" style="margin:20px;height:300px"><?php _e( 'Noch keine Daten verfügbar', 'psts' ) ?></div>
			</div>
		</div>

		<div class="postbox">
			<h3 class="hndle" style="cursor:auto;"><span><?php _e( 'Wöchentliche Aktivitätsübersicht', 'psts' ) ?></span></h3>

			<div class="inside">
				<div id="weekly_signup_stats" style="margin:20px;height:300px"><?php _e( 'Noch keine Daten verfügbar', 'psts' ) ?></div>
			</div>
		</div>

		<div class="postbox">
			<h3 class="hndle" style="cursor:auto;"><span><?php _e( 'Verhältnisse', 'psts' ) ?></span></h3>

			<div class="inside">

				<div style="width:40%;height:300px;float:left;margin-bottom:25px;">
					<h4 style="margin-left:20%;"><?php printf( __( 'Aktuelle Bloghosting Levels (%s Gesamt)', 'psts' ), number_format_i18n( $active_pro_sites ) ); ?></h4>

					<div id="pie-ratio" style="width:100%;height:100%;"><?php _e( 'Noch keine Daten verfügbar', 'psts' ) ?></div>
				</div>

				<div style="width:40%;height:300px;float:left;margin-left:10%;margin-bottom:25px;">
					<h4 style="margin-left:20%;"><?php _e( 'Aktuelle Gateway-Nutzung', 'psts' ) ?></h4>

					<div id="pie-gateway" style="width:100%;height:100%;"><?php _e( 'Noch keine Daten verfügbar', 'psts' ) ?></div>
				</div>
		...
		<div class="postbox">
			<h3 class="hndle" style="cursor:auto;"><span><?php _e( 'Bloghosting Verlauf', 'psts' ) ?></span></h3>

			<div class="inside">
				<div id="daily_stats" style="margin:20px;height:300px"><?php _e( 'Noch keine Daten verfügbar', 'psts' ) ?></div>
			</div>
		</div>

		<div class="postbox">
			<h3 class="hndle" style="cursor:auto;"><span><?php _e( 'Bloghosting Bedingungen Verlauf', 'psts' ) ?></span></h3>

			<div class="inside">
				<div id="daily_term_stats" style="margin:20px;height:300px;"><?php _e( 'Noch keine Daten verfügbar', 'psts' ) ?></div>
				<h4 style="margin-left:10%;"><?php _e( 'Aktuelle Bedingungen', 'psts' ) ?></h4>

				<div id="pie-terms" style="width:40%;height:300px;margin-bottom:25px;"><?php _e( 'Noch keine Daten verfügbar', 'psts' ) ?></div>
			</div>
		</div>
...
<?php
	...
	echo '<h3>' . __( 'Noch keine Daten verfügbar', 'psts' ) . '</h3>';
}
	echo '</div>';
}
...
function admin_levels() {
	...
	<h1><?php _e( 'Bloghosting Levels', 'psts' ); ?></h1>
	<?php
	...
	if ( isset( $_POST['delete_level'] ) ) {
		...
		if( in_array( $level_num, array_keys( $levels ) ) ) {
			...
			echo '<div class="updated fade"><p>' . sprintf( __( 'Level %s erfolgreich gelöscht.', 'psts' ), number_format_i18n( $level_num ) ) . '</p></div>';
		}
	...
	if ( isset( $_POST['add_level'] ) ) {
		...
		if ( empty( $_POST['add_name'] ) ) {
			$error[] = __( 'Bitte gib einen gültigen Levelnamen ein.', 'psts' );
		}

		if ( ! is_numeric( $_POST['add_price_1'] ) && ! is_numeric( $_POST['add_price_3'] ) && ! is_numeric( $_POST['add_price_12'] ) ) {
			$error[] = __( 'Du musst einen Preis für mindestens eine Zahlungsperiode eingeben.', 'psts' );
		}
		...
		if ( ! $error ) {
			...
			update_site_option( 'psts_levels', $levels );
			echo '<div class="updated fade"><p>' . __( 'Level hinzugefügt.', 'psts' ) . '</p></div>';
		} else {
	...
	if ( isset( $_POST['save_levels'] ) ) {
		...
		update_site_option( 'psts_levels', $levels );
		echo '<div class="updated fade"><p>' . __( 'Levels gespeichert.', 'psts' ) . '</p></div>';
	}
	...
	<form id="form-level-list" action="" method="post">
		...
		$posts_columns = array(
			'level'      => __( 'Paket', 'psts' ),
			'name'       => __( 'Name', 'psts' ),
			'is_visible' => __( 'Ist Wählbar', 'psts' ),
			'price_1'    => __( '1 Monat Preis', 'psts' ),
			'price_3'    => __( '3 Monate Preis', 'psts' ),
			'price_12'   => __( '12 Monate Preis', 'psts' ),
			'edit'       => '',
		);
		?>
		...
		<table width="100%" cellpadding="3" cellspacing="3" class="widefat level-settings" id="prosites-level-list">
			<thead>
			<tr>
				<th scope="col"><?php _e( 'Paket', 'psts' ); ?></th>
				<th scope="col"><?php _e( 'Name des Pakets', 'psts' ); ?></th>
				<th scope="col"><?php _e( 'Ist Wählbar', 'psts' ); ?></th>
				<th scope="col">
					<label><input name="enable_1" id="enable_1" value="1" title="<?php _e( 'Aktiviere 1-monatige Kaufabwicklung', 'psts' ); ?>" type="checkbox"<?php checked( in_array( 1, $periods ) ); ?>> <?php _e( '1 Monat Preis', 'psts' ); ?>
					</label></th>
				<th scope="col">
					<label><input name="enable_3" id="enable_3" value="1" title="<?php _e( 'Aktiviere Quartalsabrechnung', 'psts' ); ?>" type="checkbox"<?php checked( in_array( 3, $periods ) ); ?>> <?php _e( '3 Monate Preis', 'psts' ); ?>
					</label></th>
				<th scope="col">
					<label><input name="enable_12" id="enable_12" value="1" title="<?php _e( 'Aktiviere Jahresbeitrag', 'psts' ); ?>" type="checkbox"<?php checked( in_array( 12, $periods ) ); ?>> <?php _e( '12 Monate Preis', 'psts' ); ?>
					</label></th>
				<th scope="col"></th>
			</tr>
			</thead>
							...
							case 'edit':
								...
								<td scope="row">
									<?php if ( count( $level_list ) > 1 ) {
										...
										?>
										<input class="button" type="submit" name="delete_level[<?php echo $level_code; ?>]" value="<?php _e( 'PAKET LÖSCHEN &raquo;', 'psts' ) ?>"/>
									<?php } ?>
								</td>
								<?php
								break;
		...
		<p class="submit">
			<input type="submit" name="save_levels" class="button-primary" value="<?php _e( 'Speichere Levels', 'psts' ) ?>"/>
			<span class="save_levels_dirty" style="display:none;"><?php esc_html_e( 'Änderungen nicht gespeichert.', 'psts' ); ?></span>
		</p>

		<h3><?php _e( 'Neues Level hinzufügen', 'psts' ) ?></h3>
		<span class="description"><?php _e( 'Hier kannst Du eine neue Bloghosting-Ebene hinzufügen.', 'psts' ) ?></span>
		<table width="100%" cellpadding="3" cellspacing="3" class="widefat">
			<thead>
			<tr>
				<th scope="col"><?php _e( 'Level', 'psts' ); ?></th>
				<th scope="col"><?php _e( 'Name', 'psts' ); ?></th>
				<th scope="col"><?php _e( 'Öffentlich', 'psts' ); ?></th>
				<th scope="col"><?php _e( '1 Monat Preis', 'psts' ); ?></th>
				<th scope="col"><?php _e( '3 Monatspreis', 'psts' ); ?></th>
				<th scope="col"><?php _e( '12 Monate Preis', 'psts' ); ?></th>
				<th scope="col"></th>
			</tr>
			</thead>
			<tbody id="the-list">
			<tr>
				...
				<td>
					<input class="button" type="submit" name="add_level" value="<?php _e( 'Hinzufügen &raquo;', 'psts' ) ?>"/>
				</td>
			</tr>
			</tbody>
		</table>
...
function admin_modules() {
	...
	ProSites_Helper_UI::load_psts_style();
		...
		if ( get_option( 'psts_module_settings_updated' ) ) {
			...
			echo '<div class="updated notice-info is-dismissible"><p>' . __( 'Module gespeichert. Besuche <a href="admin.php?page=psts-settings">Einstellungen</a> um sie zu konfigurieren.', 'psts' ) . '</p></div>';
		}
		?>
		<div class="wrap">
			<div class="icon32" id="icon-plugins"></div>
			<h1><?php _e( 'Bloghosting Module', 'psts' ); ?></h1>

			<form method="post" action="">
				<?php wp_nonce_field( 'psts_modules' ) ?>

				<h3><?php _e( 'Aktiviere Module', 'psts' ) ?></h3>
				<span class="description"><?php _e( 'Wähle unten die Module aus, die Du verwenden möchtest. Du kannst ihre Optionen dann auf der Einstellungsseite konfigurieren.', 'psts' ) ?></span>
				<table class="widefat">
					<thead>
						<tr>
							<th style="width: 15px;"><?php _e( 'Aktiviere', 'psts' ) ?></th>
							<th><?php _e( 'Modul Name', 'psts' ) ?></th>
							<th><?php _e( 'Beschreibung', 'psts' ) ?></th>
						</tr>
					</thead>
						...
						<tr valign="top" class="<?php echo $css . $css2; ?>">
							<td style="text-align:center;">
								...
								if ( $plugin[2] ) { //if demo
									...
									<a class="psts-pro-update" href="https://n3rds.work/piestingtal_source/ps-bloghosting-multisite-next-level-plugin/" title="<?php _e( 'Upgrade', 'psts' ); ?> &raquo;"><?php _e( 'Nur Premium &raquo;', 'psts' ); ?></a><?php
								} else {
									?>
				...
				<p class="submit">
					<input type="submit" name="submit_module_settings" class="button-primary" value="<?php _e( 'Änderungen speichern', 'psts' ) ?>"/>
				</p>
			</form>
	...
	function checkout_grid( $blog_id, $domain = '' ) {
		...
		//show chosen blog
		$content .= '<div id="psts-chosen-blog">'.sprintf(__('Du hast Dich für ein Upgrade entschieden <strong>%1$s</strong> (%2$s).', 'psts'), get_blog_option($blog_id, 'blogname'), get_blog_option($blog_id, 'siteurl')).'
								 <a id="psts-change-blog" href="'.$this->checkout_url().'">'.__('Ändern &raquo;', 'psts').'</a><br>
								</div>';
		...
		if ( $session_coupon = ProSites_Helper_Session::session( 'COUPON_CODE' ) ) {
			...
			$content .= '<div id="psts-coupon-msg">' . sprintf( __( 'Der Gutscheincode <strong>%1$s</strong> wurde für einen Rabatt von %2$s auf die erste Zahlung angewendet. <a href="%3$s">Gutschein entfernen &raquo;</a>', 'psts' ), esc_html( $session_coupon ), $coupon_value['discount'], get_permalink() . "?bid=$blog_id&remove_coupon=1" ) . '</div>';
		...
		if ( $recurring ) {
			$content .= '<tr class="psts_level_head">
					<th>' . __( 'Pakete', 'psts' ) . '</th>';
			if ( in_array( 1, $periods ) ) {
				$content .= '<th>' . __( 'Monatlich', 'psts' ) . '</th>';
			}
			if ( in_array( 3, $periods ) ) {
				$content .= '<th>' . __( 'Alle 3 Monate', 'psts' ) . '</th>';
			}
			if ( in_array( 12, $periods ) ) {
				$content .= '<th>' . __( 'Alle 12 Monate', 'psts' ) . '</th>';
			}
			$content .= '</tr>';
		} else {
			$content .= '<tr class="psts_level_head">
					<th>' . __( 'Pakete', 'psts' ) . '</th>';
			if ( in_array( 1, $periods ) ) {
				$content .= '<th>' . __( '1 Monat', 'psts' ) . '</th>';
			}
			if ( in_array( 3, $periods ) ) {
				$content .= '<th>' . __( '3 Monate', 'psts' ) . '</th>';
			}
			if ( in_array( 12, $periods ) ) {
				$content .= '<th>' . __( '12 Monate', 'psts' ) . '</th>';
			}
			$content .= '</tr>';
		}
		...
		foreach ( $levels as $level => $data ) {
			...
			if ( in_array( 3, $periods ) ) {
				...
				$equiv = '<span class="psts-equiv">' . sprintf( __( 'Entspricht nur %s monatlich', 'psts' ), $this->format_currency( false, $price / 3 ) ) . '</span>';
				if ( in_array( 1, $periods ) && ( ( $data['price_1'] * 3 ) - $price ) > 0 ) {
					$equiv .= '<span class="psts-equiv">' . sprintf( __( 'Spare %s, indem Du 3 Monate im Voraus bezahlst!', 'psts' ), $this->format_currency( false, ( $data['price_1'] * 3 ) - $price ) ) . '</span>';
				}
			...
			if ( in_array( 12, $periods ) ) {
				...
				$equiv = '<span class="psts-equiv">' . sprintf( __( 'Entspricht nur %s monatlich', 'psts' ), $this->format_currency( false, $price / 12 ) ) . '</span>';
				if ( in_array( 1, $periods ) && ( ( $data['price_1'] * 12 ) - $price ) > 0 ) {
					$equiv .= '<span class="psts-equiv">' . sprintf( __( 'Spare %s, indem Du gleich für ein Jahr bezahlst!', 'psts' ), $this->format_currency( false, ( $data['price_1'] * 12 ) - $price ) ) . '</span>';
				}
		...
		if ( ! $this->prevent_dismiss() && ( ! empty ( $domain ) || get_blog_option( $blog_id, 'psts_signed_up' ) ) ) {
			...
			$content .= '<tr class="psts_level level-free">
				<td valign="middle" class="level-name"><h3>' . $this->get_setting( 'free_name', __( 'Basis', 'psts' ) ) . '</h3></td>';
			$content .= '<td class="level-option" colspan="' . count( $periods ) . '">';

			if ( is_user_logged_in() && empty ( $domain ) ) {

				$content .= '<a class="pblg-checkout-opt" style="width: ' . $free_width . '" id="psts-free-option" href="' . get_admin_url( $blog_id, 'index.php?psts_dismiss=1', 'http' ) . '" title="' . __( 'Verwerfen', 'psts' ) . '">' . $this->get_setting( 'free_msg', __( 'Nein Danke, ich komme vorerst mit einer Basis-Webseite aus', 'psts' ) ) . '</a>';
				...
				$content .= '<div class="pblg-checkout-opt" style="width: ' . $free_width . '" id="psts-free-option">
								...
								<label for="psts-radio-0-0">' . $this->get_setting( 'free_msg', __( 'Nein Danke, ich komme vorerst mit einer Basis-Webseite aus', 'psts' ) ) . '</label>
							</div>';
		...
		if ( ! ( defined( 'PSTS_DISABLE_COUPON_FORM' ) && PSTS_DISABLE_COUPON_FORM ) ) {
			...
			if ( is_array( $coupons ) && count( $coupons ) && ! isset( $session_coupon ) ) {
		      ...
		      <small><a id="psts-coupon-link" href="#">' . __( 'Hast Du einen Gutscheincode?', 'psts' ) . '</a></small>
		      <div id="psts-coupon-code" class="alignright" style="display: none;">
		        <label for="coupon_code">' . __( 'Gib deinen Gutscheincode ein:', 'psts' ) . '</label>
		        <input type="text" name="coupon_code" id="coupon_code" class="cctext" />&nbsp;
		        <input type="submit" name="coupon-submit" class="regbutton" value="' . __( 'Hinzufügen &raquo;', 'psts' ) . '" />
		      </div>
		     </div>';
			}
		}
	...
	function receipt_form( $blog_id, $domain = false ) {
		...
		if ( ! defined( 'PSTS_DISABLE_RECEIPT_FORM' ) && $last_transaction ) {
			...
			if ( isset( $_POST['psts_receipt'] ) ) {
				...
				$content .= '<div class="psts-updated">' . sprintf( __( 'E-Mail-Quittung an %s gesendet.', 'psts' ), esc_html( $_POST['receipt_email'] ) ) . '</div>';
			} else {
				$content .= '<p id="psts-receipt-block">
					<form action="' . $this->checkout_url( $blog_id ) . '" method="post" autocomplete="off">
					' . __( 'Sende eine Quittungskopie für Deine letzte Zahlung per E-Mail an:', 'psts' ) . ' <span id="psts-receipt-change"><strong>' . get_blog_option( $blog_id, 'admin_email' ) . '</strong> <small><a href="#">(' . __( 'ändern', 'psts' ) . ')</a></small></span>
					<input type="text" id="psts-receipt-input" name="receipt_email" value="' . get_blog_option( $blog_id, 'admin_email' ) . '" style="display: none;" />
					<input type="submit" name="psts_receipt" class="regbutton" value="' . __( 'Senden &raquo;', 'psts' ) . '" />
					</form></p>';
			}
	...
	function checkout_trial_msg( $value, $blog_id ) {
		$trial_days = $this->get_setting( 'trial_days', 0 );
		if ( $this->is_trial_allowed( $blog_id ) ) {
			return $value . '<p class="helper-message">' . sprintf( __( 'Deine <strong>%d-Tages-Testversion </strong> beginnt, sobald Du unten auf die Schaltfläche "Webseite Abonnieren" klickst.', 'psts' ), $trial_days ) . '</p>';
		}
	}
	...
	function checkout_output( $content ) {
		...
		if( ! is_user_logged_in() || ( ProSites_Helper_ProSite::allow_new_blog() && isset( $_GET['action'] ) && 'new_blog' == $_GET['action'] ) || isset( $_POST['level'] ) || ! empty( $session_data['username'] ) )  {
			...
			if( ! is_user_logged_in() && ! $show_signup ) {
				$content .= '<p>' . __( 'Du musst Dich zuerst anmelden, bevor Du eine Webseite für das Upgrade auswählen kannst:', 'psts' ) . '</p>';
		...
		if (isset($_POST['bid'])){
			...
			foreach ($blogs_of_user as $id => $obj) {
				...
				if ($permission) {
					...
					$obj->level_label = ($obj->level) ? $this->get_level_setting($obj->level, 'name') : sprintf(__('Nicht %s', 'psts'), $this->get_setting('rebrand'));
					$obj->upgrade_label = is_pro_site($obj->userblog_id) ? sprintf(__('Modifiziere "%s"', 'psts'), $obj->blogname) : sprintf(__('Upgrade "%s"', 'psts'), $obj->blogname);
		...
		if ( $blog_id ) {
			...
			restore_current_blog();
			if ( ! $permission ) {
				$content = '<p>' . __( 'Entschuldigung, aber Du hast keine Berechtigung zum Aktualisieren dieser Website. Nur der Webseiten-Administrator kann seine Webseite aktualisieren.', 'psts' ) . '</p>';
				$content .= '<p><a href="' . $this->checkout_url() . '">&laquo; ' . __( 'Wähle eine andere Webeite', 'psts' ) . '</a></p>';
			...
			if ( $this->get_expire( $blog_id ) > 2147483647 ) {
				$level   = $this->get_level_setting( $this->get_level( $blog_id ), 'name' );
				$content = '<p>' . sprintf( __( 'Diese Webseite hat dauerhaft den Status %s erhalten.', 'psts' ), $level ) . '</p>';
				...
				if ( count( $blogs ) > 1 ) {
					...
					$content .= '<div class="psts-signup-another"><a href="' . esc_url( $this->checkout_url() . '?action=new_blog' ) . '">' . esc_html__( 'Melde Dich für eine andere Webseite an.', 'psts' ) . '</a>' . '</div>';
				}
			...
			$blog_id = 0;
			if ( $blogs ) {
				$content .= '<h3>' . __( 'Bitte wähle eine Deiner Seiten zum Upgraden oder Modifizieren aus:', 'psts' ) . '</h3>';
				$content .= '<ul>';
				...
				foreach ( $blogs as $blog ) {
					 ...
					 */
					$level_label   = ( $level ) ? $this->get_level_setting( $level, 'name' ) : sprintf( __( 'Nicht %s', 'psts' ), $this->get_setting( 'rebrand' ) );
					$upgrade_label = is_pro_site( $blog->userblog_id ) ? sprintf( __( 'Modifiziere "%s"', 'psts' ), $blog->blogname ) : sprintf( __( 'Upgrade "%s"', 'psts' ), $blog->blogname );
			...
			if( !empty( $user_domain ) && $allow_multi ) {
				...
				$inactive_site = !empty( $site->active ) && 1 == $site->active ? '': sprintf( __('Deine Webseite <strong>%s</strong> wurde noch nicht aktiviert.', 'psts' ), $user_domain ). '<br/>';
				$content .= '<div class="psts-signup-another">' . $inactive_site . '<a href="' . esc_url( $this->checkout_url() . '?action=new_blog' ) . '">' . esc_html__( 'Melde Dich für eine andere Webseite an.', 'psts' ) . '</a>' . '</div>';
			}elseif( empty( $user_domain ) ) {
				//Don't have a site, let user create one
				$content .= '<h3>' . __( 'Erstelle Dir jetzt gleich eine eigene Webseite, wähle im nächsten Schritt Dein Paket:', 'psts' ) . '</h3>';
				$content .= '<div class="psts-signup"><a href="' . esc_url( $this->checkout_url() . '?action=new_blog' ) . '">' . esc_html__( 'Weiter um jetzt eine neue Webseite erstellen .', 'psts' ) . '</a>' . '</div>' ;
			}elseif ( ! $has_blog && ! isset( $session_domain ) ) {
				$content .= '<strong>' . __( 'Entschuldigung, aber anscheinend bist Du kein Administrator für eine Webseite.', 'psts' ) . '</strong>';
	...
	function pdf_receipt( $payment_info = '' ) {
		...
		$pdf->SetCreator( 'Bloghosting', 'psts' );
		$pdf->SetTitle( __( 'Zahlungsbeleg', 'psts' ) );
		$pdf->SetKeywords( '' );
	...
	function pricing_table_settings() {
		...
		if ( strtolower( $_SERVER['REQUEST_METHOD'] ) == 'post' ) {
			...
			update_site_option( 'psts_settings', $settings );
			echo '<div id="message" class="updated fade"><p>' . __( 'Einstellungen gespeichert!', 'psts' ) . '</p></div>';
		}
	...
	function psts_note() {
		...
		if ( is_main_network() && 'sites-network' == $current_screen->base ) {
			?>
			<p><strong>&#42 </strong>
			=> <?php _e( "Das ursprüngliche Level existiert nicht, es wurde möglicherweise entfernt.", 'psts' ); ?></p><?php
		}
	}
