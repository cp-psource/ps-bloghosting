...
/*
Plugin Name: Bloghosting (Feature: Ungefiltertes HTML)
*/
...
class ProSites_Module_UnfilterHtml {
	...
	public static function get_name() {
		return __( 'Ungefiltertes HTML', 'psts' );
	}

	// Module description for registering
	public static function get_description() {
		return __( 'Ermöglicht die Bereitstellung der Berechtigung "unfiltered_html" für bestimmte Benutzertypen für ausgewählte Bloghosting-Level.', 'psts' );
	}

	function __construct() {
		self::$user_label       = __( 'Ungefiltertes HTML', 'psts' );
		self::$user_description = __( 'Kann die ungefilterte HTML-Berechtigung verwenden', 'psts' );
...
<!--			</h3>-->
			...
			<div class="inside">
				<table class="form-table">
					<tr valign="top">
						<th scope="row" class="psts-help-div psts-unfilter-level"><?php echo __( 'Bloghosting Level', 'psts' ) . $psts->help_text( __( 'Wähle die Mindeststufe aus, die zum Aktivieren von ungefiltertem HTML erforderlich ist.', 'psts' ) ); ?></th>
						<td>
					...
					<tr valign="top">
						<th scope="row" class="psts-help-div psts-filtered-message"><?php echo __( 'Gefiltertes HTML Hinweis', 'psts' ) . $psts->help_text( __( 'Erforderlich - Diese Meldung wird auf dem Beitrags-/Seitenbildschirm für Webseiten angezeigt, die beim Speichern eines Beitrags keine ungefilterten HTML-Berechtigungen haben. "LEVEL" wird durch den erforderlichen Levelnamen ersetzt.', 'psts' ) ); ?></th>
						<td>
