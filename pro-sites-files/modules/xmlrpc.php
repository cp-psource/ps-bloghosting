...
/*
Plugin Name: Bloghosting (Funktion: XML-RPC & Atom Publishing einschränken)
*/
...
class ProSites_Module_XMLRPC {
	...
	public static function get_name() {
		return __( 'Beschränke XML-RPC', 'psts' );
	}

	// Module description for registering
	public static function get_description() {
		return __( 'Ermöglicht das Aktivieren von XML-RPC nur für ausgewählte Bloghosting-Ebenen.', 'psts' );
	}
	...
	function __construct() {
		...
		self::$user_description = __( 'Kann XML-RPC-Aufrufe verwenden', 'psts' );
	}
	...
	function settings() {
		...
		<div class="inside">
			<table class="form-table">
				<tr valign="top">
					<th scope="row"
					    class="psts-help-div psts-xml-prolevel"><?php echo __( 'Bloghosting Level', 'psts' ) . $psts->help_text( __( 'Wähle die Mindeststufe aus, die zum Aktivieren der Remoteveröffentlichung erforderlich ist.', 'psts' ) ); ?></th>
					<td>
				...
				<tr valign="top">
					<th scope="row"
					    class="psts-help-div psts-xml-restricted"><?php echo __( 'Hinweis für Einschränkungen ', 'psts' ) . $psts->help_text( __( 'Erforderlich - Diese Meldung wird auf dem Bildschirm für die Schreibeinstellungen auf Webseiten angezeigt, die keine Berechtigungen haben. "LEVEL" wird durch den erforderlichen Levelnamen ersetzt.', 'psts' ) ); ?></th>
					<td>
