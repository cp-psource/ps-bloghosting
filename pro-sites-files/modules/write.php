...
/*
Name des Plugins: Bloghosting (Feature: Schreiben einschränken)
*/
...
class ProSites_Module_Writing {
	...
	public static function get_name() {
		return __('Beschränke das Veröffentlichen', 'psts');
	}

	// Module description for registering
	public static function get_description() {
		return __('Ermöglicht das Aktivieren des Schreibens von Beiträgen und/oder Seiten nur für ausgewählte Bloghosting-Level.', 'psts');
	}
	...
	function __construct() {
		...
		self::$user_label       = __( 'Beschränke das Veröffentlichen', 'psts' );
		self::$user_description = __( 'Eingeschränkte Erstellung von Beitrags- und Seiteninhalten', 'psts' );
	}
...
<!--			</h3>-->
			...
			<div class="inside">
				<table class="form-table">
					<tr valign="top">
						<th scope="row" class="psts-help-div psts-limit-prolevel"><?php echo __( 'Bloghosting Level', 'psts' ) . $psts->help_text( __( 'Wähle die Mindeststufe aus, die zum Aktivieren der Veröffentlichung von Beiträgen oder Seiten erforderlich ist.', 'psts' ) ); ?></th>
						<td>
					...
					<tr valign="top">
						<th scope="row"><?php _e( 'Beiträge begrenzen', 'psts' ); ?></th>
						<td>
					...
					<tr valign="top">
						<th scope="row" class="psts-help-div psts-post-restricted"><?php echo __( 'Beiträge eingeschränkt Hinweis', 'psts' ) . $psts->help_text( __( 'Erforderlich - Diese Meldung wird auf dem Beitrags-Bildschirm für Webseiten angezeigt, die keine Berechtigungen haben. "LEVEL" wird durch den erforderlichen Levelnamen ersetzt.', 'psts' ) ) ?></th>
						<td>
					...
					<tr valign="top">
						<th scope="row"><?php _e( 'Seiten begrenzen', 'psts' ); ?></th>
						<td>
					...
					<tr valign="top">
						<th scope="row" class="psts-help-div psts-page-restricted"><?php echo __( 'Seiten eingeschränkt Hinweis', 'psts' ) . $psts->help_text( __( 'Erforderlich - Diese Meldung wird auf dem Seitenbildschirm für Webseiten angezeigt, die keine Berechtigungen haben. "LEVEL" wird durch den erforderlichen Levelnamen ersetzt.', 'psts' ) ); ?></th>
						<td>
