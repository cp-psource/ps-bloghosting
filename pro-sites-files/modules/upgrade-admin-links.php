<?php
/*
Plugin Name: Bloghosting (Funktion: Admin Upgrade Menülinks)
*/
class ProSites_Module_UpgradeAdminLinks {
	...
	public static function get_name() {
		return __('Admin Upgrade Menülinks', 'psts');
	}

	// Module description for registering
	public static function get_description() {
		return __('Ermöglicht das Hinzufügen benutzerdefinierter Menüelemente im Admin-Bereich, die Administratoren dazu ermutigen, eine höhere Ebene zu erreichen, indem sie zur Upgrade-Seite umleiten.', 'psts');
	}

	function __construct() {

		self::$user_label       = __( 'Admin Upgrade Menülink', 'psts' );
		self::$user_description = __( 'Zeigt einen praktischen Upgrade-Link im Admin-Menü an.', 'psts' );
...
<!--			<h3 class="hndle" style="cursor:auto;"><span>--><?php //_e('Upgrade Admin Menu Links', 'psts') ?><!--</span> - <span class="description">--><?php //_e('Allows you to add custom menu items in admin panel that will encurage admins to get higher level by redirecting to upgrade page.', 'psts') ?><!--</span></h3>-->
			<div class="inside">
				<table class="form-table">
					<tr valign="top">
						<th scope="row"><?php _e('Menüpunkte', 'psts') ?></th>
						<td>
							<div id="psts-ual-menu-items">
								...
								foreach ($menu_items as $id => $options) {
									...
									<p class="psts-ual-menu-item"<?php echo $additional_attrs; ?>>
										...
										<a class="button button-secondary psts-ual-menu-item-remove" href="#"><?php _e('Entfernen', 'psts') ?></a>
									</p>
								<?php
								}
								?>
							...
							<p><a id="psts-ual-menu-item-add" class="button button-secondary" href="#<?php echo $menu_items_new_key; ?>"><?php _e('Neuen Menüpunkt hinzufügen', 'psts') ?></a></p>
							<p class="description"><?php _e('Füge Admin-Menüelemente hinzu, die zur Upgrade-Seite für Websites ohne erforderliche Stufe umleiten.', 'psts') ?></p>
						</td>
					</tr>
				</table>
			</div>
