		...
		public static function get_tabs() {
			...
			$tabs = array(
				'pricing_table' => array_merge( $section_options, array(
					'title' => __( 'Preistabelle', 'psts' ),
					'desc'               => array(
						__( 'Wähle Preistabelleneinstellungen.', 'psts' ),
					),
					'class' => '',
				) ),
				'comparison_table' => array_merge( $section_options, array(
					'title' => __( 'Feature-Tabelle', 'psts' ),
					'desc'               => array(
						__( 'Wähle Feature-Tabelleneinstellungen', 'psts' ),
					),
				) ),
				'pricing_style' => array_merge( $section_options, array(
					'title' => __( 'Darstellung', 'psts' ),
					'desc'               => array(
						__( 'Ändere das Design der Preis- und Funktionstabellen.', 'psts' ),
					),
				) ),
			);
